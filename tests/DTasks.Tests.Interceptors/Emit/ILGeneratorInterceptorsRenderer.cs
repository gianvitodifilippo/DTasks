...
internal static class ILGeneratorInterceptorsRenderer
{
    public static void Render(
        ...
        ImmutableArray<InterceptionLocationInfo> methodBuilderLocations,
        ImmutableArray<InterceptionLocationInfo> constructorBuilderLocations)
    {
        source.AppendLine("""
            // <auto-generated />
    ...
    private static void AppendInterceptsLocationAttributes(StringBuilder source, ImmutableArray<InterceptionLocationInfo> locations)
    {
