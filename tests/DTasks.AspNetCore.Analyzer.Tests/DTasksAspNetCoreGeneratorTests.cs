...
public class DTasksAspNetCoreGeneratorTests
{
    [Fact]
    ...
    private static async Task RunTestAsync(string source, string method, string configuration)
    {
        ...
        var test = new CSharpSourceGeneratorTest<DTasksAspNetCoreGenerator, DefaultVerifier>
        {
            ...
            TestState =
            {
                ...
                GeneratedSources =
                {
                    (typeof(DTasksAspNetCoreGenerator), "DTasks.AspNetCore.Analyzer.Routing.g.cs", expectedMethodSource),
                    (typeof(DTasksAspNetCoreGenerator), "DTasks.AspNetCore.Analyzer.Configuration.g.cs", expectedConfigurationSource)
                },
