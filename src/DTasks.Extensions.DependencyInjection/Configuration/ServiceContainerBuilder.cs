...
internal sealed class ServiceContainerBuilder(IServiceCollection services, IDAsyncTypeResolver typeResolver)
{
    ...
    public IReadOnlyCollection<Exception> ValidationErrors => _validationErrors;
    ...
    public void Replace(ServiceDescriptor descriptor)
    {
        ...
        TypeId typeId = typeResolver.GetTypeId(descriptor.ServiceType);
